      ...
      >
        ...
        >
          ...
          <Typography variant="body1">
            My name is Wyatt Walsh and I am a curious engineer, developer, and
            scientist with manifold interests, a robust skill set, and
            impact-driven motivations.
          </Typography>
          <br />
          <Typography variant="body1">
            Growing up in the rural Eastern Sierras of California, I attended
            The Hotchkiss School, a boarding school in Northwest Connecticut,
            during the last two years of high school to gain access to better
            resources in science, technology, engineering, and mathematics. I
            then went on to the University of California, Berkeley, where I
            initially pursued a joint major program between the Bioengineering
            and Materials Science Departments with a focus on tissue
            engineering.
          </Typography>
          <br />
          <Typography variant="body1">
            ...
            world. This knowledge became the foundation for my exploration of
            data science, machine learning, computer science, and mechanical
            engineering. I was also on course staff for the Data 8: Foundations
            of Data Science course, helping to teach others.
          </Typography>
          <br />
          <Typography variant="body1">
            ...
            entrepreneurial endeavors, launching a personal project (SandLabs)
            and partnering with two Duke students. My work with the Duke
            students revolved around creating marketing data dashboards for Web3
          ...
          <Typography variant="body1">
            ...
            opportunity to further my development and to help better the lives
            of others. I am confident that my set of skills, including
            problem-solving, communication, and leadership, would be a great
            asset to the team. I am excited to be part of something bigger and
            to be able to use my skills to make a difference.
          </Typography>
        </Box>
      </Box>
    </main>
