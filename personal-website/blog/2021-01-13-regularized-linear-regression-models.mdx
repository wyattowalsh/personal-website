...
image: "/img/blog/2021-01-13-regularized-linear-regression-models/cover.png"
...
<Header
  ...
  date="2021-01-13"
  imgSrc="/img/blog/regularized-linear-regression-models-cover.png"
...
```python[class="autolinker"][class="data-uri-highlight"][class="inline-color"][class="keep-markup"][class="show-invisibles"][class="treeview"][class="line-numbers"][class="diff-highlight"][data-prismjs-copy="Copy the snippet!"]
