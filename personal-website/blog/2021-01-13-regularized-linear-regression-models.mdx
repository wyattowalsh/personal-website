...
<Hero
  imgSrc="/img/blog/2021-01-13-regularized-linear-regression-models/cover.png"
...
The models and included implementations were tested on a wine quality prediction dataset of which the code and results can be viewed at the project repository <u>**[here](http://github.com/wyattowalsh/regularized-linear-regression-deep-dive)**</u>
...
<figure>
  <img
    ...
    src="/img/blog/2021-01-13-regularized-linear-regression-models/eq5.png"
    alt="missing"
  />
  <hr />
...
<figure>
  <img
    ...
    src="/img/blog/2021-01-13-regularized-linear-regression-models/eq6.png"
    alt="missing"
  />
  <hr />
...
<figure>
  <img
    ...
    src="/img/blog/2021-01-13-regularized-linear-regression-models/eq7.png"
    alt="missing"
  />
  <hr />
...
<figure>
  <img
    ...
    src="/img/blog/2021-01-13-regularized-linear-regression-models/eq8.png"
    alt="missing"
  />
  <hr />
...
<figure>
  <img
    ...
    src="/img/blog/2021-01-13-regularized-linear-regression-models/eq9.png"
    alt="missing"
  />
  <hr />
...
<figure>
  <img
    ...
    src="/img/blog/2021-01-13-regularized-linear-regression-models/eq10.png"
    alt="missing"
  />
  <hr />
...
<figure>
  <img
    ...
    src="/img/blog/2021-01-13-regularized-linear-regression-models/eq11.png"
    alt="missing"
  />
  <hr />
