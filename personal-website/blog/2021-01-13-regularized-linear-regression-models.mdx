...
---
import "2021-01-13-regularized-linear-regression-models.module.scss";

## Context of Linear Regression, Optimization to Obtain the OLS Model Estimator, and an Implementation in Python Using Numpy

<figure>
    <img style={{width: "50vw"}} src='/img/blog/2021-01-13-regularized-linear-regression-models/cover.png' alt='missing' />
    <figcaption>Model Coefficient Value Changes With Growing Regularization Penalty Values</figcaption>
</figure>
...
<figure>
    <img style={{width: "50vw", backgroundColor: "white", color:"black", padding: "1rem"}} src='/img/blog/2021-01-13-regularized-linear-regression-models/eq1.png' alt='missing' />
    <hr/>
...
<figure >
    <img style={{width: "50vw", backgroundColor: "white", color:"black", padding: "1rem"}}  src='/img/blog/2021-01-13-regularized-linear-regression-models/eq2.png' alt='missing' />
    <hr/>
