...
> Make sure to check out the next and [final part of the series](/blog/posts/regularized-linear-regression-models-pt3) to learn about the other two forms of regularized linear regression, **the Lasso** and **the Elastic Net.**

---

## Ridge Regression

This form of regression is also known as **_Tikhonov Regularization_** and modifies the OLS loss function ([Part One: Eq. #7](/blog/posts/regularized-linear-regression-models-pt1#eq-7)) with the addition of an **_L₂_** penalty with an associated tuning parameter, **_λ_**. This loss function can be described using vector notation as:
