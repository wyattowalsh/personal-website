...
export const metadata = {
  ...
  alternates: {
    canonical: "https://w4w.dev/blog/posts/regularized-linear-regression-models-pt2",
  },
  openGraph: {
    type: "article",
    title: "Using Ridge Regression to Overcome Drawbacks of Ordinary Least Squares (OLS)",
    description: "Weaknesses of OLS, Optimization to Obtain the Ridge Model Estimator, and an Implementation in Python Using Numpy",
    url: "https://w4w.dev/blog/posts/regularized-linear-regression-models-pt2",
    images: [{ url: "https://w4w.dev/ridge.webp", width: 1200, height: 630, alt: "Ridge Regression" }],
    publishedTime: "2021-01-14",
    authors: ["Wyatt Walsh"],
    tags: ["ML", "TDS", "Python", "Optimization"],
  },
  twitter: {
    ...
    title: "Using Ridge Regression to Overcome Drawbacks of Ordinary Least Squares (OLS)",
    description: "Weaknesses of OLS, Optimization to Obtain the Ridge Model Estimator, and an Implementation in Python Using Numpy",
    images: ["https://w4w.dev/ridge.webp"],
    creator: "@wyattowalsh",
  },
};
