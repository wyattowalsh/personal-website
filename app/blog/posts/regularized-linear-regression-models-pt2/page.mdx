...
This form of regression is also known as **_Tikhonov Regularization_** and modifies the OLS loss function (Equation #7) with the addition of an **_L₂_** penalty with an associated tuning parameter, **_λ_**. This loss function can be described using vector notation as:
