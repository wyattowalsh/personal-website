...
export const metadata = {
  ...
  alternates: {
    canonical: "https://w4w.dev/blog/posts/regularized-linear-regression-models-pt3",
  },
  openGraph: {
    type: "article",
    title: "Implementing Pathwise Coordinate Descent For The Lasso and The Elastic Net In Python Using NumPy",
    description: "Explanations for Solving Some of the Most Popular Supervised Learning Algorithms",
    url: "https://w4w.dev/blog/posts/regularized-linear-regression-models-pt3",
    images: [{ url: "https://w4w.dev/lasso.webp", width: 1200, height: 630, alt: "Lasso and Elastic Net" }],
    publishedTime: "2021-01-15",
    authors: ["Wyatt Walsh"],
    tags: ["ML", "TDS", "Python", "Optimization"],
  },
  twitter: {
...
<ArticleJsonLd
  ...
  slug="regularized-linear-regression-models-pt3"
  tags={["ML", "TDS", "Python", "Optimization"]}
/>
