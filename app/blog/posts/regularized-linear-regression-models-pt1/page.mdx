...
$$
y_i = \beta_0 + \beta_1 x_{i,1} + \beta_2 x_{i,2} + \dots + \beta_p x_{i,p} + \epsilon_i, \quad \forall i \in \{1, \dots, n\}
\\[1em]
\text{Where:}

\begin{align*}
p \quad &: \text{Number of features} \\
n \quad &: \text{Number of samples} \\
\epsilon_i \quad &: \text{Error term with a mean of zero and finite variance}
\end{align*} 
$$
